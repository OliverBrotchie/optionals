...
<p><strong>Rust-like <code>Option</code> and <code>Result</code> for TypeScript.</strong></p>

<p>Runs everywhere: <a href="#bun">Bun</a> (primary), <a href="#deno">Deno</a>, and <a href="#node">Node</a>.</p>
...
`instanceof` guards, with zero runtime dependencies.
...
```ts
import { Option, Some, None, Result, Ok, Err } from "https://deno.land/x/optionals/mod.ts";
```
